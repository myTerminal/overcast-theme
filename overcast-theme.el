...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(fringe ((,class (:background ,bgcolor-level1 :foreground ,color-level3))))
   `(vertical-border ((,class (:foreground ,color-level2))))
   `(show-paren-match-face ((,class (:background ,color-warning))))
   `(isearch ((,class (:bold t :foreground ,color-warning :background ,bgcolor-level2))))
   ...
   ;; Modeline
   `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,color-level3 :background ,bgcolor-level1))))
   ...
   `(org-level-1 ((,class (:bold t :foreground ,color-level1 :height 1.1))))
   `(org-level-2 ((,class (:bold nil :foreground ,color-level2))))
   `(org-level-3 ((,class (:bold t :foreground ,color-level3))))
   `(org-level-4 ((,class (:bold nil :foreground ,bgcolor-level3))))
   ...
   `(org-todo ((,class (:box (:line-width 1 :color ,color-level2) :foreground ,color-keyword :bold t))))
   `(org-done ((,class (:box (:line-width 1 :color ,bgcolor-level2) :bold t :foreground ,bgcolor-level3))))
